...
class MajsterMatrycy:
    ...
    def matryca_tworzenie_wzorcow_wyszukiwania(self):
        ...
        self.wklej_dany_wzor(wzor,self.rozmiar -7,0)
        self.wklej_dany_wzor(wzor,0,self.rozmiar-7)
    ...
    def matryca_tworzenie_separatorow(self):
        for i in range(8):
            ...
            self.matryca[7][self.rozmiar-1-i] = 0
            self.matryca[i][self.rozmiar-8] = 0

            self.matryca[self.rozmiar-1-i][7] = 0
            self.matryca[self.rozmiar-8][i] = 0
    ...
    def zbuduj_pelna_matryce(self):
        self.tworzenie_matrycy()
        self.matryca_tworzenie_wzorcow_wyszukiwania()
        self.matryca_tworzenie_separatorow()
        self.matryca_tworzenie_wzorcow_wyrownania()
        self.matryca_tworzenie_wzorcow_czasowych()
        self.matryca_tworzenie_ciemnego_modulu()
        self.matryca_tworzenie_miejsc_zarezerwowanych()
        self.zapamietanie_strefy_danych()
        self.matryca_tworzenie_bitow_danych()
